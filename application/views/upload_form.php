    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url();?>">SMPN 19 Bandung</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                        ...
                        <input type="file" name="userfile" size="20" class="btn btn-primary" class="form-control" />
                        </div>
                        <div class="form-group col-lg-12">
