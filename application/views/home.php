                        ...
                        <!-- panel-heading -->
							...
							<!-- /.panel-heading -->
							 <div class="panel-body">
								<?php
									$no = 0;
									foreach ($datapersonal->result() as $rows):$no++;
										if($rows->status == 2 && $rows->no_urut != 0){?>
											<div align="center"><h2>Selamat Atas Kelulusan <br> <?= $rows->name?><br> di <br> SMP NEGERI 19 BANDUNG <br></h2>
											<h3> Harap melakukan daftar ulang ke sekolah dan membawa kartu pendaftaran</h3>
											</div>
											<?php
										}else{
											if($rows->lulus == 1 ){?>
											
												<div align="center"><h2>Mohon Maaf Anda Belum Lulus <br> di <br> SMP NEGERI 19 BANDUNG </h2></div>
												<?php }else{?>
												 <div align="center"><h2>Selamat Datang </h2></div>
												<?php
											}
										}
									endforeach;
