			...
			<ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?=base_url();?>index.php/siswa/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form text-center" align="center">
                               ...
                               <img  style="border-radius:50px;border:1px solid grey" width="50%" height="50%" src="<?=base_url();?>assets/img/siswa/<?= $photo;?>"  style="text-align:center" >
                            </div>
                            <!-- /input-group -->
                        </li>
					   <li class="sidebar-search">
