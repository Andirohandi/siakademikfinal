                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="Form-add-guru" id="myModalLabel">Form Add Guru</h4>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <input type="text" name="nm_guru" class="form-control" placeholder="Name Guru">
											</div>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                                        ...
                                                        foreach ($listguru->result() as $rows) {
                                                    	?>
                                    										<tr>
                                    											<td><?= $rows->id_guru?></td>
                                    											<td><?= $rows->nm_guru?></td>
                                                                                ...
                                                                                <td><a href="guru/delete/<?= $rows->id_guru?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Delete
                                                                                    </button></a>
                                                                                    <a href="guru/formupdate/<?= $rows->id_guru?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Update
                                                                                    </button></a>                                                        
                                                                                </td>
