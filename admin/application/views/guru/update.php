                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                            <?php                                                        
                                            foreach ($listguruselect->result() as $rows) {
                                            ?>
                                            ...
                                            <label>ID Guru</label>
                                            <input type="text" name="id_guru" class="form-control" placeholder="ID Guru" value="<?= $rows->id_guru?>" readonly>
                                            </div>

                                            <div class="form-group">
                                            <label>Name Guru</label>
                                            <input type="text" name="nm_guru" class="form-control" placeholder="Name Guru" value="<?= $rows->nm_guru?>">
                                            </div> 
                                            ...
                                            <div class="form-group">
                                            <label>No. Telp</label>
                                            <input type="text" name="telp" class="form-control" placeholder="No. Telp" value="<?= $rows->telp?>">
                                            </div> 
                                            ...
                                            <a href="<?=base_url();?>index.php/guru"><input type="button" value="Cancel" class="btn btn-default"></a>
                                            </div>
                                            <?php echo form_close(); ?>
                                            <?php } ?>  
                        </div>
