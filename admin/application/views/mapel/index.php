                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="Form-add-pelajaran" id="myModalLabel">Form Add Mata Pelajaran</h4>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <input type="text" name="nm_pelajaran" class="form-control" placeholder="Name Pelajaran">
											</div>
                                            ...
                                            <?php foreach ($combobox_guru->result() as $rowmenu) {
                                                        ?>
                                            <option value="<?= $rowmenu->id_guru?>"  ><?= $rowmenu->nm_guru?></option>
                                            <?php
                                            }
                                            ?>
                                            </select> 
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                                        ...
                                                        foreach ($listmapel->result() as $rows) {
                                                    	?>
                                    										<tr>
                                    											<td><?= $rows->id_mapel?></td>
                                                                                ...
                                                                                <td><a href="mapel/delete/<?= $rows->id_mapel?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Delete
                                                                                    </button></a>
                                                                                    <a href="mapel/formupdate/<?= $rows->id_mapel?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Update
                                                                                    </button></a>
                                                                                    <a href="mapel/siswa/<?= $rows->id_mapel?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Siswa
                                                                                    </button></a>                                                         
                                                                                </td>
