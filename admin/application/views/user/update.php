                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                            ...
                                            <input type="text" name="nm_user_first" class="form-control" placeholder="Name User Awal" value="<?= $rows->nm_user_first?>">
                                            </div>

                                            <div class="form-group">
                                            <label>Name User Akhir</label>
                                            <input type="text" name="nm_user_last" class="form-control" placeholder="Nama User Akhir" value="<?= $rows->nm_user_last?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                            <label>Tahun</label>
                                            <input type="text" name="tahun" class="form-control" placeholder="Tahun Walikelas" value="<?= $rows->tahun?>">
                                            </div>
                                            <div class="form-group">
                                            <label>Kelas</label>
                                            <input type="text" name="kelas" class="form-control" placeholder="Kelas Walikelas" value="<?= $rows->kelas?>">
                                            </div>
                                            <hr>
