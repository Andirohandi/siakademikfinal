    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                     <div class="col-lg-12">
                    <h1 class="page-header">Siswa Lulus</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                                        ...
                                                        foreach ($tahunajaran->result() as $rows) {
                                                    	?>
                                    										<tr>
                                    											<td><?= $rows->id_tahun_ajaran?></td>
                                    											<td><?= $rows->tahun?></td>
                                                                               
                                    											<td><?= $rows->status?></td>
                                                                                <td>
                                                                                   
                                                                                <a href="lulus/generate/<?= $rows->id_tahun_ajaran?>/<?= $rows->tahun?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Generate Kelas
                                                                                    </button></a>
                                                                                <a href="lulus/detail_lulus?thn=<?= $rows->tahun?>">
                                                                                    <button class="btn btn-primary" >
                                                                                        Detail
                                                                                    </button></a>                                                   
                                                                                </td>
