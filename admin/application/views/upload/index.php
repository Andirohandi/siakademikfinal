    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                     <div class="col-lg-12">
                    <h1 class="page-header">Upload Data Siswa Tahun Ajaran <?php echo $tahun_ajaran;?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
						<form action="<?php echo site_url('upload/do_upload?xYz='.base64_encode($tahun_ajaran))?>" method="post" enctype="multipart/form-data" role="form">
							<input type="file" id="import" name="import" required="required"><br/>
							<input type="submit"  value="Upload" name="save" class="btn btn-primary" />
							<a href='<?php echo site_url('tahun_ajaran')?>' class="btn btn-default"  value="Upload" name="save" class="btn btn-primary" /> Cancel </a>
						</form>
					</div>
					<?php if($result==1){
					echo "
