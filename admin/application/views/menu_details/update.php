                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                            ...
                                            <label>ID Menu Details</label>
                                            <input type="text" name="id_menu_details" class="form-control" placeholder="ID Menu Details" value="<?= $rows->id_menu_details?>" readonly>
                                            </div>

                                            <div class="form-group">
                                            <label>Name Menu Details</label>
                                            <input type="text" name="nm_menu_details" class="form-control" placeholder="Name Menu Details" value="<?= $rows->nm_menu_details?>">
                                            </div>                                            
